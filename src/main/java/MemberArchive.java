...
public class MemberArchive {
    ...
    public void listAllMembers() {
        ...
        for (BonusMember bonusMember: members.values()) {
            System.out.println("Name:    " + bonusMember.getName());
            System.out.println("Email:   " + bonusMember.getMailAddress());
            System.out.println("Member:  " + bonusMember.getMembershipName() + ", "
                    + bonusMember.getBonusPointBalance() + " bonus points");
            System.out.println();
        }
    }
